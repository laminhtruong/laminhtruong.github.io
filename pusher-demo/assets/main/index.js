...
System.register("chunks:///_virtual/GameMgr.ts",["./_rollupPluginModLoBabelHelpers.js","cc","./QRCode.ts"],(function(e){"use strict";var t,r,i,a,n,s,o,c,u,l,h;return{setters:[function(e){t=e.applyDecoratedDescriptor,r=e.inheritsLoose,i=e.initializerDefineProperty,a=e.assertThisInitialized,n=e.defineProperty},function(e){s=e.cclegacy,o=e._decorator,c=e.Node,u=e.Vec3,l=e.Component},function(e){h=e.QRCode}],execute:function(){var p,m,f,d,g,v,b,P,y;s._RF.push({},"980f3AafxNK36ipk+geXF5p","GameMgr",void 0);var w=o.ccclass,R=o.property;e("GameMgr",(p=w("GameMgr"),m=R(c),f=R(h),d=R([c]),p((b=t((v=function(e){function t(){for(var t,r=arguments.length,s=new Array(r),o=0;o<r;o++)s[o]=arguments[o];return t=e.call.apply(e,[this].concat(s))||this,i(a(t),"aim",b,a(t)),i(a(t),"qrcode",P,a(t)),i(a(t),"items",y,a(t)),n(a(t),"target",void 0),n(a(t),"userParams",{}),n(a(t),"channel",void 0),t}r(t,e);var s=t.prototype;return s.start=function(){var e=this;this.UpdateParams();var t=new window.Pusher("14a0ba1af62c520bdce4",{cluster:"ap1"});this.channel=t.subscribe("gameloft-game"),this.userParams.server&&(this.qrcode.CreateQR("https://laminhtruong.github.io/pusher-demo/index.html?server=false"),this.channel.bind("move",(function(t){e.Select(null,t)}))),this.qrcode.node.parent.active=this.userParams.server,this.aim.active=this.userParams.server},s.update=function(e){if(null!=this.target){var t=new u(0,0,0);u.lerp(t,this.aim.position,this.target,.1),this.aim.setPosition(t)}},s.ParseUrl=function(e){for(var t,r=/[?&]([^=#]+)=([^&#]*)/g,i={};t=r.exec(e);)i[t[1]]=decodeURIComponent(t[2]);return i},s.UpdateParams=function(){var e=this.userParams,t=this.ParseUrl(window.location.href);Object.keys(t).forEach((function(r){e[r]=t[r]}))},s.Select=function(e,t){this.userParams.server?this.target=this.items[parseInt(t)].position:this.channel.trigger("move",t)},t}(l)).prototype,"aim",[m],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),P=t(v.prototype,"qrcode",[f],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),y=t(v.prototype,"items",[d],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return[]}}),g=v))||g));s._RF.pop()}}}));
