    ...
    execute: function () {
      ...
      Ball = (_dec = property({
        ...
        _createClass(Ball, [{
          ...
          key: "Throw",
          value: function Throw(index, x, min, max, combo) {
      ...
      BallMgr = (_dec = property({
        ...
        _createClass(BallMgr, [{
          ...
          value: function Throw(noteIndex) {
            ...
            if (objectBall != null) {
              objectBall.getComponent(Ball).Throw(noteIndex, this.ballThrowPosition[noteIndex], this.minX, this.maxX, this.combo);
            }
          }
        }, {
          key: "OnScore",
          value: function OnScore(args) {
            ...
            this.beatIndex = args.index;
            EventMgr.instance.emit(BallEvent.COMBO, _objectSpread2({}, args, {
              combo: this.combo,
              progress: this.beatIndex / (this.notes.length - 1)
            }));
          }
        }]);
...
System.register("chunks:///ui/ProgressBar.js", ["../_virtual/_rollupPluginBabelHelpers.js", "cc"], function (_export, _context) {
  "use strict";

  var _applyDecoratedDescriptor, _inherits, _classCallCheck, _possibleConstructorReturn, _getPrototypeOf, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, SpriteComponent, Node, ParticleSystemComponent, Component, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _temp, ccclass, property, ProgressBar;
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "fe170XaqNtPUZ2519hbRDDZ", "ProgressBar", undefined);

      ccclass = _decorator.ccclass;
      property = _decorator.property;

      _export("ProgressBar", ProgressBar = (_dec = ccclass('ProgressBar'), _dec2 = property({
        ...
        function ProgressBar() {
          ...
          _initializerDefineProperty(_this, "stars", _descriptor2, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "musicNote", _descriptor3, _assertThisInitialized(_this));
        ...
        _createClass(ProgressBar, [{
          key: "start",
          value: function start() {} // update(deltaTime: number)
          // {
          ...
          value: function SetProgress(progress) {
            ...
            this.musicNote.setPosition(0, 270 * progress, 0);

            if (progress == 0) {
              this.Reset();
            } else {
              while (progress >= (this.currentStar + 1) * 0.3333) {
                this.SetStar(this.currentStar++);

                if (this.currentStar == this.stars.length) {
                  break;
                }
              }
            }
          ...
          key: "SetStar",
          value: function SetStar(index) {
            var isStop = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
            var ps = this.stars[index].getComponentsInChildren(ParticleSystemComponent);
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "musicNote", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///ui/Ingame.js", ["../_virtual/_rollupPluginBabelHelpers.js", "cc", "./ProgressBar.js"], function (_export, _context) {
  "use strict";

  var _applyDecoratedDescriptor, _inherits, _classCallCheck, _possibleConstructorReturn, _getPrototypeOf, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Prefab, Node, LabelComponent, instantiate, SpriteComponent, Color, tween, Vec3, Component, ProgressBar, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _temp, ccclass, property, Ingame;
...
System.register("chunks:///GameMgr.js", ["./_virtual/_rollupPluginBabelHelpers.js", "cc", "./Defines.js", "./EventMgr.js", "./BallMgr.js", "./core/Input.js", "./Basket.js", "./ui/Ingame.js"], function (_export, _context) {
  "use strict";

  var _applyDecoratedDescriptor, _inherits, _classCallCheck, _possibleConstructorReturn, _getPrototypeOf, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, AudioSourceComponent, PhysicsSystem, Vec3, loader, Component, BallEvent, AmaReadContent, EventMgr, BallMgr, Input, Basket, Ingame, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, _cc$_decorator, ccclass, property, STATE, GameMgr;
      ...
      GameMgr = (_dec = property({
        ...
        _createClass(GameMgr, [{
          ...
          value: function OnCombo(args) {
            ...
            this.viewIngame.SetProgress(args.progress);
          }
        }]);
...
System.register("chunks:///_virtual/prerequisite-imports:main", ["../Defines.js", "../EventMgr.js", "../Ball.js", "../core/Timer.js", "../BallMgr.js", "../core/Input.js", "../Basket.js", "../ui/ProgressBar.js", "../ui/Ingame.js", "../GameMgr.js", "../ui/Background.js"], function (_export, _context) {
  "use strict";

  return {
    setters: [function (_DefinesJs) {}, function (_EventMgrJs) {}, function (_BallJs) {}, function (_coreTimerJs) {}, function (_BallMgrJs) {}, function (_coreInputJs) {}, function (_BasketJs) {}, function (_uiProgressBarJs) {}, function (_uiIngameJs) {}, function (_GameMgrJs) {}, function (_uiBackgroundJs) {}],
    execute: function () {}
  };
});
