System.register(["./application.f8cd8.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_applicationF8cd8Js) {
      createApplication = _applicationF8cd8Js.createApplication;
    }],
    execute: function () {
